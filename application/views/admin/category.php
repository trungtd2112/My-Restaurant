...
<script>
    $(function() {
        ...
        $('html').on('click', '.delete_button', function(event) {
            ...
            $.ajax({
                    type: "post",
                    url: '<?php echo base_url() ?>' + 'admin/Category/deleteDishCategory/' + dc_id,
                    dataType: "json"
                })
                .always(function() {
        ...
        $('body').on('click', '.jquery_edit_button', function() {
            dc_id = $(this).parent().parent().prev().children().data('href');
            new_cat = $(this).prev().children('input').val();
            $.ajax({
                type: "post",
                url: "<?php echo base_url() ?>" + "admin/Category/editDishCategory/" + dc_id,
                data: {
                    'dc_name': new_cat
                },
                dataType: "json"
